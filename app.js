...
function multiplyArray(multArr) { //eslint-disable-line
  var multiplyNum = multiply(testArray[0],testArray[1])[0];
  var multiplyTwo = multiply(multiplyNum,testArray[2])[0];
  var arr = [];
  arr.push(multiplyTwo);

  var msg = 'The numbers '+ testArray[0] + ',' + testArray[1] + ',' + testArray[2] + ' have a product of ' + multiplyTwo + '.'; 
